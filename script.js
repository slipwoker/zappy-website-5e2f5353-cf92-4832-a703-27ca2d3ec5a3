    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "נייר וקרטון הדרום משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '5e2f5353-cf92-4832-a703-27ca2d3ec5a3',
                    name: data.name || '',
                    email: data.email || '',
